  ...
  return (
    <section id="projects" className="section bg-light">
      <div className="container">
        <h2 className="text-center section-heading">Key Projects</h2>
        <div className="row">
          <div className="col-md-6 col-lg-4 mb-4">
            <div className="card h-100 shadow-sm">
              <img src="https://placehold.co/300x200?text=Wells+Fargo" className="card-img-top" alt="Wells Fargo Project" />
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <div className="card h-100 shadow-sm">
              <img src="https://placehold.co/300x200?text=Spectrum+CUS" className="card-img-top" alt="Spectrum CUS Project" />
              <div className="card-body d-flex flex-column">
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <div className="card h-100 shadow-sm">
              <img src="https://placehold.co/300x200?text=MapEx+GIS" className="card-img-top" alt="MapEx Project" />
              <div className="card-body d-flex flex-column">
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <div className="card h-100 shadow-sm">
              <img src="https://placehold.co/300x200?text=Combat+CMS" className="card-img-top" alt="CMS Project" />
              <div className="card-body d-flex flex-column">
